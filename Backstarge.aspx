<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Backstarge.aspx.cs" Inherits="backstage_index" %>
...
<head runat="server">
    ...
    <link rel="icon" href="./backstage/images/favicon.ico">
    <link rel="stylesheet" href="./backstage/lib/layui-v2.5.4/css/layui.css" media="all">
    <link rel="stylesheet" href="./backstage/css/layuimini.css" media="all">
    <link rel="stylesheet" href="./backstage/lib/font-awesome-4.7.0/css/font-awesome.min.css" media="all">
            ...
            <div class="layui-header header">
                ...
                <ul class="layui-nav layui-layout-right"> 
                    ...
                    <li class="layui-nav-item layuimini-setting">
                        <a href="javascript:;"><span id="welcome" runat="server" ></span></a>
...
<script src="./backstage/lib/layui-v2.5.4/layui.js?v=1.0.4" charset="utf-8"></script>
<script src="./backstage/js/lay-config.js?v=1.0.4" charset="utf-8"></script>
<script>
    layui.use(['element', 'layer', 'layuimini'], function () {
        ...
        layuimini.init('./backstage/api/init.json');
